...
class MenuHeader extends React.Component {
  render() {
    return (
      <div>
        <div className="nav navbar nav-default row">
          <i className="fa fa-bars"></i>
          <input className="input-form" placeholder="Search"/>
          <div className="personal ml-auto navbar">
            ...
            <div className="personal__item">
              ...
              <sup className="badge badge-primary">1</sup>
            </div>
            <div className="personal__item nav-item">
              <div className="dropdown">
                <a className="text-dark nav-link dropdown-toggle bg-light"
